...
+ (id) safeDictionaryGet:(NSDictionary*)dic path:(NSArray*)paths{
	...
	if([res isKindOfClass:[NSString class]])
		res = [NSString stringWithString:[res stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]]];
	if([res isKindOfClass:[NSString class]] ||
	   [res isKindOfClass:[NSNumber class]] ||
	   [res isKindOfClass:[NSArray class]] ||
	   [res isKindOfClass:[NSDictionary class]])
		return (NSConstantString*)res;
	return @"";
}
